...
// Update this endpoint to your existing pipeline API.
// Expected POST body: { question, modelId, sampleSize }
// Expected response: { seValue, threshold, delta, sampleSize, clusters: [{ id, representative, count, color, variations }] }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-10">
          <input
            ...
            placeholder="Enter a question to run analysis..."
            value={question}
        ...
        {!data && !isAnalyzing && (
          <div className="mt-12 text-center p-12 bg-white/90 rounded-[3rem] border border-dashed border-slate-200">
            ...
            <p className="text-slate-400 text-sm max-w-sm mx-auto mb-6">
              Select your analysis depth and enter a question. The model will generate answers (N) to calculate
              semantic divergence.
            </p>
